...
namespace Modul05
{
		...
		public static void Main (string[] args)
		{
			...
			do 
			{
				...
				if ( usercommand.Contains ( "cmd03" ) )
				{
					...
					Console.WriteLine ("Komandata ne e vuvedena korektno");
					}
				...
				if ( usercommand.Contains ( "cmd05" ) ) 
					{
					Console.WriteLine ("Broi chetni chisla: " + cmd05 ( usercommand ).Length.ToString () );
		...
		public static void cmd01 ( string _input )  //test 5 > 5^2
			...
			try
			{
				...
				if ( double.TryParse ( _input.Split(' ')[1], out  _temp ) )
					{
						Console.WriteLine ("\nRezultat ot " + _temp.ToString () + "^2: " + (_temp * _temp ).ToString() );
				}
	...
	public static bool cmd03 ( string _input, out double _i)   //cmd03 45 ^2
		{
			try
			{
		...
		public static string[] cmd05 ( string _input )
		{
			...
			try
			{
				...
				if ( int.TryParse ( _input.Split (' ')[1], out _border))
				{
					...
					Console.WriteLine ( _temp );   //samo za proverka
